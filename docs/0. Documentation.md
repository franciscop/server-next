...
[`auth`](/documentation/options#optionsauth): logging in. The one-liner (`auth: 'cookie:github'`) needs no database at all; add the `onLogin`/`getUser` callbacks when you want your own user records.
