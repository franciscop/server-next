...
Server.js has no built-in template engine; return the rendered string from your route and it's served as `text/html`. See [Templates](/documentation#templates) for EJS, Pug and Handlebars examples, or [JSX](/documentation#jsx) on Bun.
